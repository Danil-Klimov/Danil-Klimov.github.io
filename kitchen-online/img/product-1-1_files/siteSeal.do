...
ss_msg = "";
  ...
  ss_msg = "Пожалуйста щелкните здесь для просмотра профиля.";
...
function ss_open_sub(){
  ...
  ss_url_p1          = "0c7b7cbb"
  ss_url_p2          = "088689e148ceae89db2e36e203445076cc940b8b53c2dbb01c90f3de86706bb01d00092de8d315d116deccac098db0e6da2937e41f1c096dd7"
  ss_url_p3          = "41ac6c89296a6a59c80be5efc59b1a9af9e667da"
...
function writeFlash() {
  ...
  var str =
    ...
    "<PARAM NAME='flashVars' VALUE='timeText=08:37:06(UTC)'>" +
    "<PARAM NAME='wmode' VALUE='transparent'>" +    
    "<EMBED src='" + ss_flashLocation + "' FlashVars='timeText=08:37:06(UTC)'" +
    " WIDTH='" + ss_width + "'" +
    " HEIGHT='" + ss_height + "'" +
    " NAME='ss_imgTag'" +
